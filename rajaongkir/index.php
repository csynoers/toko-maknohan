      		...
      		$.ajax({
            	...
            	data :  {'kab_id' : kab, 'kurir' : kurir, 'asal' : asal, 'berat' : berat},
					success: function (data) {
						...
						if(n.length==1){
							$("#ongkos").html('<thead style="background-color:green;color:white;"><tr><th style="text-align:left">Paket</th><th>Deskripsi 1</th><th>Lama Pengiriman</th><th style="text-align:right;">Ongkir (Rp)</th></tr></thead><tbody><tr><td style="text-align:left;"><input type=radio name=radio value='+service[0]+'><input type=hidden value='+service[0]+'>'+service[0]+'</td><td>'+description[0]+'</td><td>'+sampai[0]+'</td><td style="text-align:right;"><input type=hidden name=ongkos value='+ongkos[0]+'>'+ongkos[0]+'</td></tr></tbody>');
						} else if(n.length==2){
							...
							$("#ongkos").html('<thead style="background-color:green;color:white;"><tr><th style="text-align:left">Paket</th><th>Deskripsi 1</th><th>Lama Pengiriman</th><th style="text-align:right;">Ongkir (Rp)</th></tr></thead><tbody><tr><td style="text-align:left;color:red;">KOSONG</td><td style="color:red;">KOSONG</td><td style="color:red;">KOSONG</td><td style="text-align:right;color:red;">KOSONG</td></tr></tbody>');
						}
